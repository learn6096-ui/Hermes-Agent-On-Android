...
# Install Python 3.13 with dev headers and venv support
echo "🐍 Installing Python 3.13..."
apt-get install -y python3.13 python3.13-venv python3.13-dev >/dev/null 2>&1

# Make python3.13 the default python3 via update-alternatives
...
# Setup Python virtual environment with Python 3.13
if [ -d "venv" ]; then
